...
-- TRAJECTORY_BUILDER_3D.ceres_scan_matcher.occupied_space_weight_1 =4 
...
-- TRAJECTORY_BUILDER_3D.real_time_correlative_scan_matcher.linear_search_window  =0.3
...
TRAJECTORY_BUILDER_3D.pose_extrapolator.use_imu_based_gtsam=true
TRAJECTORY_BUILDER_3D.pose_extrapolator.imu_based.local_pose_rotation_noise=0.1
TRAJECTORY_BUILDER_3D.pose_extrapolator.imu_based.local_pose_translation_noise =0.01
TRAJECTORY_BUILDER_3D.pose_extrapolator.imu_based.imu_gry_noise =0.05
TRAJECTORY_BUILDER_3D.pose_extrapolator.imu_based.imu_acc_noise =0.05

-- TRAJECTORY_BUILDER_3D.pose_extrapolator.imu_based.gravity_constant=-10
TRAJECTORY_BUILDER_3D.pose_extrapolator.imu_based.imu_acceleration_weight=200
...
-- POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.min_low_resolution_score= 0.70
POSE_GRAPH.optimization_problem.acceleration_weight=100
